...
const likePost = async (postId) => {
  ...
  try {
    const response = await axios.put(`${baseUrl}/like/EV/${postId}/`, null, {
      headers: {
        'Authorization': `Bearer ${token}`,
        'Content-Type': 'application/json',
      },
...
const bookmarkPost = async (postId) => {
  ...
  try {
    const response = await axios.put(`${baseUrl}/bookmark/EV${postId}/`, null, {
      headers: {
        'Authorization': `Bearer ${token}`,
        'Content-Type': 'application/json',
      },
...
const getUserEvents = async () => {
  ...
  try {
    const response = await axios.get(`${baseUrl}/events/user/`, {
      headers: {
        'Authorization': `Bearer ${token}`,
        'Content-Type': 'application/json',
      },
